...
export interface RenameLecturerReqDto {
    /** @format int64 */
    id: number;
    name: string;
}
...
export interface CIWDDepartmentDto {
    name: string;
    shortName?: string;
}
...
export interface UpdateArchiveEntryReqDto {
    /** @format int64 */
    id: number;
    name: string;
    linkToMoodle: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    api = {
         ...
         * @secure
         */
        renameUser: (data: RenameLecturerReqDto, params: RequestParams = {}) =>
            this.request<UserResDto, any>({
                path: `/api/user`,
                method: "PUT",
                body: data,
         ...
         * @tags user-controller
         * @name ResetPassword
         * @request POST:/api/user/{id}/reset_password
         * @secure
         */
        resetPassword: (id: number, params: RequestParams = {}) =>
            this.request<void, any>({
                path: `/api/user/${id}/reset_password`,
                method: "POST",
                secure: true,
                ...params,
            }),
         ...
         */
        refresh: (data: RefreshReqDto, params: RequestParams = {}) =>
         ...
         *
         * @tags archive-controller
         * @name UpdateArchiveEntry
         * @request PATCH:/api/archive
         * @secure
         */
        updateArchiveEntry: (data: UpdateArchiveEntryReqDto, params: RequestParams = {}) =>
            this.request<ArchiveEntryResDto, any>({
                path: `/api/archive`,
                method: "PATCH",
                body: data,
         ...
         * @request DELETE:/api/archive/{id}
         * @secure
         */
        deleteArchiveEntry: (id: number, params: RequestParams = {}) =>
            this.request<void, any>({
                path: `/api/archive/${id}`,
                method: "DELETE",
                secure: true,
